    ...
    <footer class="footer-distributed" style="background-color:black" id="aboutUs">
        ...
        <div class="footer-center">
            <div>
                ...
                <p style="font-size:20px">Agro Culture Fam<span>WATER</span></p>
            </div>
            <div>
                <i class="fa fa-phone"></i>
                <p style="font-size:20px">070781510</p>
            </div>
            <div>
                <i class="fa fa-envelope"></i>
                <p style="font-size:20px"><a href="mailto:wkimutai8@gmail.com" style="color:white">Wkimutai86@gmail.com</a></p>
            </div>
        </div>
